        ...
        <div class="col-md-12">
            ...
            ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input type="date" class="form-control" <?php echo $data['tanggal_peminjaman']; ?> name="tanggal_peminjaman">         
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8 ">
                        <input type="date" class="form-control" <?php echo $data['tanggal_pengembalian']; ?> name="tanggal_pengembalian">         
                    </div>
                </div>
