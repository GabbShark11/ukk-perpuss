            ...
            $i = 1;
                ...
                while($data =mysqli_fetch_array($query)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?page=laporan_ubah&&id=<?php echo $data['id_buku']; ?>" class="btn btn-warning mx-2">Ubah</a>
                            <a onclick="return confirm('Apakah anda yakin menghapus data ini?')" href="?page=laporan_hapus&&id=<?php echo $data['id_buku']; ?>" class="btn btn-danger">Hapus</a>
                        </td>
